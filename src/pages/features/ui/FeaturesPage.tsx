  ...
  return (
    <section className="relative overflow-hidden">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg">{t('features.heroSubtitle')}</p>
      </AnimateOnScroll>
    </section>
  );
}
            ...
            <StaggerItem key={name} preset="fade-up">
              <Card
                className={`flex h-full flex-col border transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md ${
                  highlight
                    ? 'border-primary/30 shadow-primary/5 shadow-md'
    ...
    <section className="bg-muted/50 py-20 md:py-28">
      <div className="mx-auto max-w-4xl px-6 text-center">
        <AnimateOnScroll preset="fade-up">
          <h2 className="mb-4 text-3xl font-bold md:text-4xl">{t('features.privacyTitle')}</h2>
          <p className="text-muted-foreground mb-12 text-lg">{t('features.privacySubtitle')}</p>
        </AnimateOnScroll>
        <StaggerContainer className="grid gap-6 sm:grid-cols-3" stagger={0.1}>
...
function PlatformsSection() {
  ...
  return (
    <section className="py-20 md:py-28">
      <div className="mx-auto max-w-4xl px-6 text-center">
        <AnimateOnScroll preset="fade-up">
          <h2 className="mb-4 text-3xl font-bold md:text-4xl">{t('features.platformsTitle')}</h2>
          <p className="text-muted-foreground mb-12 text-lg">{t('features.platformsSubtitle')}</p>
        </AnimateOnScroll>
  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-28">
      ...
      >
        ...
        <Button
          size="lg"
          className="shadow-primary/20 h-14 rounded-2xl px-10 text-lg shadow-lg"
          asChild
        >
          <a href={lp('/pricing')}>
            {t('pricingTeaser.cta')}
